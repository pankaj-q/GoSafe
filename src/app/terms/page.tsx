    ...
    <>
      ...
      <section className="gosafe-container py-10">
        <div className="max-w-3xl mx-auto space-y-6">
          {sections.map(s => {
            const Icon = s.icon
            return (
              <div key={s.title} className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-100 dark:border-gray-800">
                <div className="flex items-center gap-2.5 mb-3">
                  <div className="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center shrink-0">
                    <Icon className="w-4 h-4 text-blue-600" />
                  </div>
                  <h2 className="font-bold text-gray-900 dark:text-gray-100 text-sm">{s.title}</h2>
                </div>
      ...
      <section className="bg-gray-50 dark:bg-gray-900/60 border-y border-gray-100 dark:border-gray-800">
        <div className="gosafe-container py-8">
          <div className="max-w-3xl mx-auto text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            <h2 className="font-bold text-gray-900 dark:text-gray-100 mb-2">Governing Law</h2>
            <p>
      ...
      <section className="gosafe-container py-10 text-center">
        <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-1">Questions about these terms?</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Contact our legal team</p>
        <a
