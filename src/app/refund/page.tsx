  ...
  return (
    <>
      ...
      <section className="gosafe-container py-10">
        <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 text-center mb-6">Refund Timelines by Payment Mode</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {modes.map(m => {
            const Icon = m.icon
            return (
              <div key={m.title} className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-100 dark:border-gray-800 hover:border-blue-100 hover:shadow-sm transition-all text-center">
                <Icon className="w-8 h-8 text-blue-600 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 text-sm">{m.title}</h3>
                <div className="inline-block bg-green-50 dark:bg-green-500/10 text-green-700 dark:text-green-400 text-xs font-semibold px-2.5 py-0.5 rounded-full mt-1.5 mb-2">
                  {m.timeline}
                </div>
      ...
      <section className="bg-gray-50 dark:bg-gray-900/60 border-y border-gray-100 dark:border-gray-800">
        <div className="gosafe-container py-10">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">Refund Process</h2>
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex gap-4 items-start bg-white dark:bg-gray-900 rounded-xl p-4 border border-gray-100 dark:border-gray-800">
                  <span className="text-xs font-bold text-blue-600 bg-blue-50 dark:bg-blue-500/10 px-2 py-1 rounded-md shrink-0">{item.step}</span>
                  <div>
      ...
      <section className="gosafe-container py-10">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100">Important Points</h2>
          </div>
      ...
      <section className="bg-gray-50 dark:bg-gray-900/60 border-y border-gray-100 dark:border-gray-800">
        <div className="gosafe-container py-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Didn&apos;t receive your refund?</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-5">Contact our support team and we&apos;ll resolve it within 24 hours</p>
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <a href="/contact" className="inline-flex items-center gap-2 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 font-medium px-5 py-2.5 rounded-xl text-sm border border-gray-200 dark:border-gray-800 hover:border-blue-200 transition-colors">
